...
//altsyncram CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="Cyclone V" ENABLE_RUNTIME_MOD="NO" NUMWORDS_A=256 OPERATION_MODE="SINGLE_PORT" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="CLOCK0" POWER_UP_UNINITIALIZED="FALSE" read_during_write_mode_port_a="NEW_DATA_NO_NBE_READ" WIDTH_A=8 WIDTH_BYTEENA_A=1 WIDTHAD_A=8 address_a clock0 data_a q_a rden_a wren_a
...
module  ram_one_port_altsyncram
	( 
	address_a,
	clock0,
	data_a,
...
endmodule //ram_one_port_altsyncram
//VALID FILE
...
`endif
	...
	ram_one_port_altsyncram	ram_one_port_altsyncram_component (
				.address_a (address),
				.clock0 (clock),
				.data_a (data),
				.rden_a (rden),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL ram_one_port.vhd TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL ram_one_port.inc FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL ram_one_port.cmp TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL ram_one_port.bsf TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL ram_one_port_inst.vhd FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL ram_one_port_syn.v TRUE
