...
# ACDS 19.1 670 win32 2020.05.28.14:58:00
# ----------------------------------------
...
# ----------------------------------------
# If pllsystem is one of several IP cores in your
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "F:/embedded/quartus/quartuslite/quartus/"
}
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pllsystem.vho"
}
